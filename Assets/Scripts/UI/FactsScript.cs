...
public class FactsScript : MonoBehaviour
{
    ...
    private string[] factsList = {
        ...
        "The Wadden Sea serves as a vital nursery area for many marine species, providing a safe place for young fish and other marine life to grow.",
        ...
        "Stingrays have specialized sensory organs called ampullae of Lorenzini that detect electrical fields produced by prey.",
    ...
    private string[] factsList2 =
    {
        ...
        "De Waddenzee dient als een belangrijke kraamkamer voor veel mariene soorten en biedt een veilige plek voor jonge vissen en ander zeeleven om te groeien.",
        ...
        "Pijlstaartroggen hebben gespecialiseerde zintuiglijke organen genaamd ampullen van Lorenzini die elektrische velden van prooien detecteren.",
