...
public class FactsScript : MonoBehaviour
{
    ...
    "The Wadden Sea's tides expose vast sea beds at low tide.",
    ...
    "Sardines feed on plankton using their gills.",
    "Sturgeons have existed for over 200 million years.",
    ...
    "Atlantic salmon migrate from the ocean to rivers to breed.",
    ...
    "Opah live in 50-500 meters deep ocean waters.",
    ...
    {
    "De Waddenzee is een UNESCO-werelderfgoed met unieke biodiversiteit.",
    "De Waddenzee heeft het grootste systeem van wadden en modderplaten ter wereld.",
    ...
    "Meer dan 10.000 soorten dieren leven in de Waddenzee, waaronder bedreigde.",
    ...
    "De Waddenzee is een belangrijke broedplaats voor veel mariene soorten.",
    "Mannelijke zeepaardjes dragen en baren hun jongen.",
    "Zeepaardjes kunnen van kleur veranderen om te schuilen.",
    "Sardines zwemmen in grote scholen voor bescherming.",
    "Sardines voeden zich met plankton via hun kieuwen.",
    "Steuren bestaan al 200 miljoen jaar!",
    ...
    "Zalmen kunnen watervallen opspringen tijdens migratie.",
    ...
    "Koningsvissen zijn de enige volledig warmbloedige vissen.",
    "Een Koningsvis leeft in 50-500 meter diepe oceaanwateren.",
    "Een Koningsvis kan meer dan 2 meter lang worden en meer dan 100 kg wegen.",
